...
void loop()
{
    ...
    digitalWrite(BLUE, LOW); // LED azul => clase 2: QUIETO (esperando)

    } else if (result.classification[1].value > 0.3) {
    digitalWrite(RED, LOW); // LED rojo => clase 1: IZDA-DECHA
    digitalWrite(GREEN, HIGH);
    digitalWrite(BLUE, HIGH);

    } else if (result.classification[0].value > 0.35) {
    digitalWrite(RED, HIGH);
    digitalWrite(GREEN, LOW); // LED verde => Clase 0: ARRIBA-ABAJO
    digitalWrite(BLUE, HIGH);
    } // end if
